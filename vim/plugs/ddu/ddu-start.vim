...
nnoremap <silent> ;f <Cmd>call ddu#start(#{name: 'split', sources: [#{name: 'file', params : #{expandSymbolicLink: v:true, ignoredDirectories: v:true}}, #{name: 'directory', params : #{expandSymbolicLink: v:true}}]})<CR>
