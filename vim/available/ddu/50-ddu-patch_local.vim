...
call ddu#custom#patch_local('quickfix_history', Ddu_custom_cfg('floating',  6*&columns/8, 3*&lines/8, v:true, 'horizontal', 6*&columns/8, 3*&lines/8))
...
call ddu#custom#patch_local('markdown', extend(Ddu_custom_cfg('floating', 15, 6*&lines/8, v:true, 'vertical',6*&columns/8-15, 6*&lines/8), {'sources': [{'name': 'markdown'}]}))
